...
namespace AlmeidaSebastian_ExamenProgreso1.Controllers
{
    public class CelularController : Controller
    {
        ...
        public CelularController(SebastianAlmeidaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,Modelo,Anio,Precio")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Numero,Modelo,Anio,Precio")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
